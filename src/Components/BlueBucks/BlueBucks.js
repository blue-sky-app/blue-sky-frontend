...
export function BlueBucks() {
    ...
    return ( < >
        ...
        <
        Card.Header className = "d-flex justify-content-center align-items-center mb-2 border-0"
        id = "cardh" > { fName }
        's Blue Bucks History < /Card.Header >
        ...
        /div> < /
        Card.Body > <
        Card.Text className = "text-center mr-3 ml-3 mb-1 mt-3"
        id = "earned" >
        Blue Bucks are earned through special promotions and upon payment of services and can be redeemed
        for future service discounts. <
        /Card.Text> <
        DeskFooter / >
        <
        /Card> < /
