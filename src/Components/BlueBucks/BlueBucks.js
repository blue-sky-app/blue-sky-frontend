            ...
            <BrowserView>
                ...
                <Card className="border-0 w-75 mx-auto">
                    <Card.Header 
                        ...
                        style={{backgroundColor:"#FFF", height: "40px", fontWeight: "bold", color: "#0a7ebd", fontSize: "20px"}}
                    >
                        {users.firstName}'s Blue Bucks History
                    </Card.Header>
                    
                    <Card.Body className="mx-auto w-50" style={{overflowY: "scroll", maxHeight: "100vh"}}>
                        <Card.Title style={{fontSize: "18px"}}>Current Balance: <strong>{currentBalance}</strong></Card.Title>
                            <Table striped bordered hover size="sm">
                                <thead style={{backgroundColor: "#434444", color: "white", fontSize: "16px",  textAlign: "center"}}>
                                    <tr>
