...
export function Home() {
    ...
    return ( <
        ...
        meta name = "Blue Sky Home"
        content = "Welcome to Blue Sky, we are your go to for Commercial and Residential cleaning!" /
        >
        <
        meta property = "og:title"
        content = "Blue Sky Home" / >
        <
        meta property = "og:image"
        content = "../Images/Header.png"
        alt = "Company logo reading BLUESKY, half light blue, half navy blue, animated breezy cloud background." / >
        <
        /MetaTags>
        ...
        <
        Card.Header className = "flex-row mt-3 mb-3 ml-3 mr-3 border-0"
        id = "background"
        style = {
            { backgroundImage: `url(${selPicture})` } } >
        <
        ...
        id = "header" >
        <
        Card.Text className = "text-center mr-1 ml-1"
        id = "ctext" >
        <
        div >
        <
        ...
        <
        div className = "d-flex mx-auto justify-content-center border border-dark border-3"
        style = {
            { backgroundImage: `url("${mSelPicture}")` } }
        id = "image"
        alt = "Men at work commercial cleaning." >
        < /div>

        <
        Card.Body className = "d-flex p-1 pt-3 flex-column justify-content-center align-items-center"
        id = "cardbody" >
        <
        Card.Text className = "text-center mr-3 ml-3 mb-1"
        id = "blueyou" >
        WHAT CAN BLUE DO FOR YOU ?
        <
        /Card.Text> <
        Card.Text className = "mr-2 ml-2 mt-2 text-center"
        id = "estimates" >
        All estimates and proposals are guaranteed
        for six months and are completed free of charge <
        /Card.Text> <
        /Card.Body> <
