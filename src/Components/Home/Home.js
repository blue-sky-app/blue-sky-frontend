      ...
      <>
        <BrowserView>
          ...
          <BrowserNavBar />
            ...
            <Card className="border-0 mx-auto">
                ...
                >
                  <Card.Text className="text-center w-75" style={{fontSize: "20px", color:"#434444"}}>
                ...
                <Card.Body className="d-flex flex-column justify-content-center align-items-center" style={{backgroundColor: "#014388"}}>
                  <Card.Text className="text-center mr-3 ml-3 mb-1" style={{fontSize: "14px", color: "#FFF", fontWeight: "bold"}}>
                      WHAT CAN BLUE DO FOR YOU?              
                  </Card.Text>
                  <Card.Text className="mr-3 ml-3 mt-2 text-center" style={{fontSize: "11px", color: "#FFF", fontWeight: "bold"}}>
        ...
        <MobileView>
          ...
          <Card className="border-0">
              ...
              <Image src={HeroImage} className="d-flex w-100 mx-auto justify-content-center border border-dark border-3" style={{maxHeight: "30vh"}}></Image>
