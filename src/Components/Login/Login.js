...
export function Login() {
    ...
    return (
        <>
            <BrowserView>  
                <div className="d-flex flex-column mx-auto" style={{backgroundImage:"linear-gradient(to bottom, #b1ddf2, #e6f2ff", height: "100vh", maxWidth: "50%"}}>
                    <Image src={BlueSkyLogo} className="mx-auto" style={{maxWidth: "100%"}} />
                    <p className="mt-1 w-80 mx-auto text-center" style={{fontSize:"11px", fontWeight:"bold", color:"#0a7ebd"}}>SERVING CENTRAL FLORIDA</p>
