...
function SignUp(props) {
    ...
    return ( <
        ...
        div >
        <
        p className = "mt-1 w-80 mx-auto text-center"
        id = "ltext" >
        ...
        className = "mb-1" >
        <
        Form.Control className = "fcontrol"
        type = "email"
        value = { state.email }
        ...
        /Form> <
        /div> <
        div className = "mt-2 mb-5 w-50 mx-auto"
        id = "form" >
        <
        Button href = "/login"
        variant = "secondary"
        ...
        <
        Image className = "d-flex flex-column mx-auto"
        id = "mimg"
        src = { BlueSkyLogo }
        alt = "Company logo reading BLUESKY, half light blue, half navy blue, animated breezy cloud background." /
        >
        ...
        br / >
        <
        p className = "mt-3 w-80 mx-auto text-center"
        id = "text" >
        SERVING CENTRAL FLORIDA <
        /p> <
        /div> <
