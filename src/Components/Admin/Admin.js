...
export function Admin() {
    ...
    return ( <
        ...
        alt = "BlueSky Logo at the top all pages"
        className = "d-flex w-100 mx-auto justify-content-center" /
        >
        <
        Card className = "border-0" >
        <
        Card.Header className = "d-flex justify-content-center align-items-center mb-1 border-0"
        id = "bchead" >
        Admin Console <
        /Card.Header> <
        ...
        <
        Image src = { HeaderLogo }
        alt = "BlueSky Logo at the top of all pages"
        className = "d-flex w-100 mx-auto justify-content-center" /
        >
        <
        Card className = "border-0"
