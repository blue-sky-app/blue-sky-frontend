...
export function Estimates() {
    ...
    return ( <
        ...
        <
        div className = "d-inline-block text-left w-100" > { categoryTable } <
        /div> <
        /div> <
        div style = {
        ...
        id = "mcbody" >
        <
        Card.Title className = "mb-3 ml-3"
        id = "mctitle" >
        <
        strong > { accountType } < /strong> Services <
        /Card.Title>
        ...
        <
        Form className = "ml-3" > { categoryTable } { textField } <
