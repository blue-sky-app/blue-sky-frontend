...
export function ThankYou() {
    return ( <
        ...
        <
        Card.Header className = "d-flex justify-content-center align-items-center mb-4 border-0"
        id = "bchead" >
        ...
        id = "bctitle" >
        Your estimate will be reviewed by one of our technicians and you will receive a quote via email to < strong > { email } < /strong> <
        /Card.Title> <
        div className = "thanks"
        id = "thanksText" > Thank You! < /div> <
        div className = "tcontact"
        id = "thanksText" > We will contact you shortly... < /div> <
        /Card.Body> <
        DeskFooter / >
        <
        /Card> <
