    ...
    <>
        ...
        <Navbar style={{backgroundColor:"#0a7ebd"}}>
            ...
            <Nav className="mx-auto">
                ...
                <Nav.Link href="/estimates" style={{fontWeight: "bold", color: "white"}}>ESTIMATE</Nav.Link>
                <Nav.Link href="/services" style={{fontWeight: "bold", color: "white"}}>SERVICES</Nav.Link>
                <Nav.Link href="/blueBucks" style={{fontWeight: "bold", color: "white"}}>BLUE BUCKS</Nav.Link>
                <Nav.Link href="/login" style={{fontWeight: "bold", color: "white"}}>LOG OUT</Nav.Link>
            </Nav>
        </Navbar>
    </>
  )
